...
exports.encodeBuffer = function(buf, options) {
  ...
  switch(remainingBytes) {
    ...
    case 3:
      ...
      break;
    case 4:
      var next32 = buf.readUInt32BE(i);

      retVal += base32Chars[next32 >>> 27];
      retVal += base32Chars[(next32 >>> 22) & maskFirstBits_5];
      retVal += base32Chars[(next32 >>> 17) & maskFirstBits_5];
      retVal += base32Chars[(next32 >>> 12) & maskFirstBits_5];
      retVal += base32Chars[(next32 >>> 7) & maskFirstBits_5];
      retVal += base32Chars[(next32 >>> 2) & maskFirstBits_5];
      retVal += base32Chars[(next32 & maskFirstBits_2) << 3];
      retVal += paddingChar;
  }
